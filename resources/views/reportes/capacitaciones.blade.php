        ...
        <form method="GET" action="{{ route('reportes.capacitaciones') }}" class="filter-form" id="reportForm">
            <div class="row g-3">
                <div class="col-md-4">
                    ...
                    <input type="date" id="desde" name="desde" class="form-control" value="{{ request('desde') }}" required>
                </div>
                <div class="col-md-4">
                    <label for="hasta" class="form-label">Hasta</label>
                    <input type="date" id="hasta" name="hasta" class="form-control" value="{{ request('hasta') }}" required>
                </div>
