                    ...
                    <div class="card-header bg-white border-0 d-flex justify-content-between align-items-center">
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                <li><a class="dropdown-item" href="{{ route('reportes.capacitaciones') }}">Exportar
                                        Reporte</a></li>
            ...
            options: {
                ...
                plugins: {
                    ...
                    tooltip: {
                        ...
                        callbacks: {
                            label: context =>
                                ` ${context.parsed} participantes (${Math.round(context.parsed/context.dataset.data.reduce((a, b) => a + b, 0)*100)}%)`
                        }
                    }
                }
            }
