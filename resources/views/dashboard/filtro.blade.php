    ...
    <div class="card filter-card shadow-sm mb-4">
        <div class="card-body p-3">
            <form method="GET" action="{{ route('dashboard.filtro') }}">
                <div class="row g-3">
                    <!-- Filtro por Edad -->
                    <div class="col-md-3">
                        <label class="form-label small text-muted mb-1"><i class="fas fa-user-clock me-1"></i>Edad</label>
                        <input type="number" name="edad" class="form-control form-control-sm" 
                               placeholder="Ej: 25" value="{{ request('edad') }}">
                    </div>
                    
                    <!-- Filtro por Género -->
                    <div class="col-md-3">
                        <label class="form-label small text-muted mb-1"><i class="fas fa-venus-mars me-1"></i>Género</label>
        ...
        <select name="nivel_educativo" class="form-select form-select-sm">
            ...
            <option value="Universitaria Incompleta" {{ request('nivel_educativo') == 'Universitaria Incompleta' ? 'selected' : '' }}>Universitaria Incompleta</option>
                    ...
                    <!-- Filtro por Empresa -->
                    <div class="col-md-3">
                        <label class="form-label small text-muted mb-1"><i class="fas fa-building me-1"></i>Empresa</label>
                    ...
                    <div class="col-md-3">
                        <label class="form-label small text-muted mb-1"><i class="fas fa-map-marker-alt me-1"></i>Municipio</label>
            ...
            <div class="table-responsive">
                <table class="table table-sm table-hover align-middle mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="text-center fw-bold text-muted">{{ ($participantes->currentPage() - 1) * $participantes->perPage() + $loop->iteration }}</td>
                            <td>
                            ...
                            <td class="text-center">
                                <span class="badge rounded-pill bg-{{ $participante->genero == 'Femenino' ? 'success' : 'primary' }} bg-opacity-10 text-{{ $participante->genero == 'Femenino' ? 'success' : 'primary' }}">
                                    {{ $participante->genero }}
                                </span>
                            </td>
