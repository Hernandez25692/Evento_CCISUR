                ...
                <form id="form-participante"
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" name="nombre_completo"
                                value="{{ $participante->nombre_completo }}" required>
                        </div>

                        <div class="col-md-6">
                            <label class="form-label">Correo Electrónico</label>
                            <input type="email" class="form-control" name="correo" value="{{ $participante->correo }}"
                                required>
                        </div>

                        <div class="col-md-6">
                            <label class="form-label">Teléfono</label>
                            <input type="text" class="form-control" name="telefono" value="{{ $participante->telefono }}"
                                required>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" name="identidad"
                                value="{{ $participante->identidad }}" required>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" class="form-control" name="edad" value="{{ $participante->edad }}"
                                required>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="form-select" name="nivel_educativo" required>
                                ...
                                @foreach ($niveles as $nivel)
                                    <option value="{{ $nivel }}"
                                        {{ $participante->nivel_educativo == $nivel ? 'selected' : '' }}>
                                        {{ $nivel }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" name="ciudad" value="{{ $participante->ciudad }}"
                                required>
                        </div>
                        ...
                        @if (strtolower($capacitacion->medio) === 'pago')
                            <div class="col-md-6">
                                ...
                                @if ($participante->comprobante)
                                    <small class="text-muted">
                                        Ya adjunto: <a href="{{ asset('storage/' . $participante->comprobante) }}"
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" id="precio" name="precio"
                                    value="{{ $participante->precio }}" readonly>
                            </div>

                            <div class="col-md-4">
                                <label class="form-label">ISV</label>
                                <input type="text" class="form-control" id="isv" name="isv"
                                    value="{{ $participante->isv }}" readonly>
                            </div>

                            <div class="col-md-4">
                                <label class="form-label">Total a Pagar</label>
                                <input type="text" class="form-control" name="total" id="total"
                                    value="{{ $participante->total }}" readonly>
                            </div>
                        @endif
                    </div>
                    ...
                    <div class="mt-4 d-flex flex-wrap gap-2 justify-content-between">
                        ...
                        <a href="{{ route('capacitaciones.participantes', $capacitacion->id) }}"
                            class="btn btn-secondary">🔙 Volver a Lista</a>
                    </div>
                </form>
            </div>
        </div>
