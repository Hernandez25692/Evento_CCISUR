            ...
            <div class="card-body">
                <form id="form-participante" action="{{ route('capacitaciones.participantes.store', $capacitacion->id) }}"
                    ...
                    <div class="mt-4 d-flex flex-wrap gap-2 justify-content-between">
                        ...
                        <a href="{{ route('capacitaciones.participantes', $capacitacion->id) }}" class="btn btn-info">🔍
                            Mostrar Participantes</a>
        ...
        <div class="card shadow-sm">
            <div class="card-body">
                ...
                <form action="{{ route('participantes.importar', $capacitacion->id) }}" method="POST"
                    enctype="multipart/form-data" class="d-flex flex-column flex-md-row gap-3 align-items-center">
                    @csrf
