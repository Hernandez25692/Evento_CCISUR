...
<div class="participant-form-container">
            ...
            <div class="form-grid">
                ...
                <div class="form-section">
                    ...
                    <div class="form-group floating-form-group">
                        <input type="text" class="form-control floating-input" name="nombre_completo" id="nombre_completo" required>
                        <label for="nombre_completo" class="floating-label">Nombre Completo</label>
                        <i class="fas fa-user input-icon"></i>
                    </div>
                    
                    <div class="form-group floating-form-group">
                        <input type="email" class="form-control floating-input" name="correo" id="correo" required>
                        <label for="correo" class="floating-label">Correo Electrónico</label>
                        <i class="fas fa-envelope input-icon"></i>
                    </div>
                    
                    <div class="form-group floating-form-group">
                        <input type="text" class="form-control floating-input" name="telefono" id="telefono" required>
                        <label for="telefono" class="floating-label">Teléfono</label>
                        <i class="fas fa-phone input-icon"></i>
                    </div>
                    
                    <div class="form-group floating-form-group">
                        <input type="text" class="form-control floating-input" name="identidad" id="identidad" placeholder=" " required>
                    ...
                    <div class="row g-2">
                        <div class="col-md-6 form-group floating-form-group">
                            <input type="number" class="form-control floating-input" name="edad" id="edad" required>
                ...
                <div class="form-section">
                    ...
                    <div class="form-group floating-form-group">
                        <input type="text" class="form-control floating-input" name="municipio" id="municipio" required>
                        <label for="municipio" class="floating-label">Municipio</label>
                        <i class="fas fa-city input-icon"></i>
                    </div>
                    
                    <div class="form-group floating-form-group">
                        <input type="text" class="form-control floating-input" name="ciudad" id="ciudad" required>
                ...
                <div class="form-section payment-section">
                    ...
                    <div class="form-group file-upload-group">
                        <label class="file-upload-label">
                            <input type="file" name="comprobante" id="comprobante" accept=".jpg,.jpeg,.png,.pdf" class="file-upload-input">
    ...
    <div class="import-card glassmorphism-card">
        ...
        <form action="{{ route('participantes.importar', $capacitacion->id) }}" method="POST" enctype="multipart/form-data" class="import-form">
            @csrf
        ...
        <div class="import-footer">
            <a href="{{ asset('storage/Formato_Participante/Formato_Participantes.xlsx') }}" class="download-template">
