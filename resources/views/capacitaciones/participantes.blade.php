                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="participant-info">
                                                    ...
                                                    <div class="participant-email text-muted small">{{ $p->correo }}
                                                    </div>
                                                </div>
                                            </td>
                                            <td>{{ $p->identidad }}</td>
                                            ...
                                            <td>
                                                <span
                                                    class="badge bg-{{ $p->genero == 'Femenino' ? 'success' : 'primary' }}">
                                                    {{ $p->genero }}
                                                </span>
                                            </td>
                                            <td>
                                                <div class="company-info">
                                                    ...
                                                    <div class="company-position small text-muted">{{ $p->puesto ?? '-' }}
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
