...
<div class="training-edit-container">
    ...
    <div class="edit-content">
        <div class="edit-card">
            <form action="{{ route('capacitaciones.update', $capacitacion->id) }}" method="POST" enctype="multipart/form-data" class="edit-form" novalidate>
                @csrf
                @method('PUT')
                ...
                <section class="form-section">
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="nombre" name="nombre" value="{{ $capacitacion->nombre }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="impartido_por" name="impartido_por" value="{{ $capacitacion->impartido_por }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="lugar" name="lugar" value="{{ $capacitacion->lugar }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" id="fecha" name="fecha" value="{{ $capacitacion->fecha }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <select id="tipo_formacion" name="tipo_formacion">
                                ...
                                @foreach (['Webinar', 'Charla', 'Taller', 'Seminario', 'Capacitación', 'Diplomado', 'Charla informativa'] as $tipo)
                                    <option value="{{ $tipo }}" {{ $capacitacion->tipo_formacion == $tipo ? 'selected' : '' }}>
                                        {{ $tipo }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group" id="limite_participantes_container" style="display: {{ $capacitacion->cupos == 'limitado' ? 'flex' : 'none' }}">
                            <label for="limite_participantes">
                                <i class="fas fa-user-slash"></i> Límite de Participantes
                            </label>
                            <input type="number" id="limite_participantes" name="limite_participantes" value="{{ $capacitacion->limite_participantes }}">
                        </div>
                        ...
                        <div id="precios_pago" style="display: {{ $capacitacion->medio == 'pago' ? 'grid' : 'none' }}" class="pricing-grid">
                            <div class="form-group">
                                <label>Precio Afiliado</label>
                                <input type="number" step="0.01" name="precio_afiliado" value="{{ $capacitacion->precio_afiliado }}">
                            </div>
                            <div class="form-group">
                                <label>ISV Afiliado</label>
                                <input type="number" step="0.01" name="isv_afiliado" value="{{ $capacitacion->isv_afiliado }}">
                            </div>
                            <div class="form-group">
                                <label>Precio No Afiliado</label>
                                <input type="number" step="0.01" name="precio_no_afiliado" value="{{ $capacitacion->precio_no_afiliado }}">
                            </div>
                            <div class="form-group">
                                <label>ISV No Afiliado</label>
                                <input type="number" step="0.01" name="isv_no_afiliado" value="{{ $capacitacion->isv_no_afiliado }}">
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section class="form-section">
                    ...
                    @if ($capacitacion->imagen)
                        <div class="current-image">
                            <p>Imagen actual:</p>
                            <img src="{{ asset('storage/' . $capacitacion->imagen) }}" alt="Imagen actual de la capacitación">
                        </div>
                    @endif
