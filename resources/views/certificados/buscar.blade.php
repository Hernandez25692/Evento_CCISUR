                    ...
                    <div class="search-card card border-0 shadow-lg">
                            ...
                            <div class="d-flex align-items-center justify-content-center">
                                <div class="certificate-icon animate__animated animate__bounceIn">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="currentColor" viewBox="0 0 16 16">
                                        ...
                                        <path d="M2.5 4a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5H3a.5.5 0 0 1-.5-.5V4zM4 8.5a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5zm0 2a.5.5 0 0 1 .5-.5h4a.5.5 0 0 1 0 1h-4a.5.5 0 0 1-.5-.5z"/>
                                    </svg>
                                </div>
                                <h1 class="search-title mb-0 ms-3 animate__animated animate__fadeIn">
                                    Consulta de Certificados
                                    <span class="d-block text-muted fs-5 fw-normal mt-1">Encuentra tus diplomas de capacitación</span>
                                </h1>
                            </div>
                        </div>
                        ...
                        <div class="card-body px-4 px-md-5 py-4">
                            <form method="POST" action="{{ route('certificados.resultado') }}" id="searchForm" class="needs-validation" novalidate>
                                ...
                                <button type="submit" class="btn btn-primary btn-lg w-100 py-3 search-btn" id="submitBtn">
                        ...
                        <div class="card-footer bg-transparent border-0 pt-0 pb-4 text-center">
                            <a href="#" class="text-decoration-none small text-muted help-link" data-bs-toggle="modal" data-bs-target="#helpModal">
                ...
                <div class="row g-4">
                    <div class="col-md-4">
                        <div class="info-card h-100">
                            ...
                            <p class="info-text">Obtén acceso instantáneo a tus certificados con solo ingresar tu identidad.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="info-card h-100">
                            ...
                            <p class="info-text">Descarga tus diplomas en formato PDF con un solo clic cuando los necesites.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="info-card h-100">
                            ...
                            <p class="info-text">Tus datos están protegidos y solo tú puedes acceder a tus certificados.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-body">
                ...
                <div class="d-flex">
                    ...
                    <div>
                        ...
                        <p class="small mb-0">Si tienes problemas con la búsqueda, contacta al departamento de registros.</p>
                    </div>
                </div>
            </div>
