...
<div class="container py-5">
    ...
    <form method="POST" action="{{ route('diploma.publico.buscar') }}" class="mb-5">
        ...
        <div class="row justify-content-center mb-3">
            <div class="col-md-6">
                <input type="text" name="identidad" class="form-control form-control-lg" placeholder="Ingrese su número de identidad" required>
            </div>
            <div class="col-md-2">
    ...
    @isset($participante)
        <div class="card shadow-sm">
            <div class="card-header bg-primary text-white">
                <h5 class="mb-0">Resultados para: {{ $participante->nombre_completo }} ({{ $participante->identidad }})</h5>
            </div>
            <div class="card-body">
                        ...
                        <tbody>
                            @foreach($capacitaciones as $index => $cap)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('diplomas.descargar', ['capacitacion_id' => $cap->id, 'identidad' => $participante->identidad]) }}" class="btn btn-sm btn-success" target="_blank">
